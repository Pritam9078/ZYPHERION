            ...
            <aside className="space-y-8">
              <motion.div initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} className="p-8 rounded-[2.5rem] glass-blue border-white/5">
                ...
                <div className="space-y-4">
                  ...
                  <a href="https://github.com/zypherion/sdk" target="_blank" rel="noreferrer" className="block p-4 bg-black/20 hover:bg-black/40 border border-white/5 rounded-2xl transition-all group">
