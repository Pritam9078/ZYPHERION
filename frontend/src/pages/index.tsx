    ...
    <div className="min-h-screen bg-white dark:bg-zypher-bg text-slate-900 dark:text-slate-200 selection:bg-blue-500/30 overflow-x-hidden transition-colors duration-300">
      ...
      <main className="relative z-10 container mx-auto px-6 pt-24 pb-32 flex flex-col items-center">
        ...
        >
          ...
          <span className="text-[10px] font-black text-blue-500 dark:text-blue-400 tracking-[0.15em] uppercase">Status: Protocol_Nominal_Alpha</span>
        </motion.div>
        ...
        >
          <h1 className="text-6xl md:text-8xl font-black tracking-tight text-slate-900 dark:text-white mb-8 leading-[0.9]">
            Infrastructure <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-500 dark:from-blue-500 dark:to-indigo-400">Sovereignty_</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            {wallet.address ? (
               <Link 
                ...
                className="px-12 py-5 bg-slate-900 dark:bg-white text-white dark:text-slate-950 rounded-2xl font-black text-[11px] uppercase tracking-[0.1em] shadow-2xl shadow-blue-500/10 hover:bg-blue-600 dark:hover:bg-blue-600 hover:text-white dark:hover:text-white transition-all transform hover:-translate-y-1"
               >
             ...
             <div className="grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
                {[
                  ...
                  <div key={i} className="text-center md:text-left">
                     <div className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-wider mb-2">{s.label}</div>
        ...
        <div className="w-full max-w-6xl mt-32">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight mb-4 uppercase">Protocol_Initiation_Sequence_</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={idx} className="relative p-8 glass rounded-3xl border border-slate-200 dark:border-white/5 group hover:border-blue-500/50 transition-all">
                <div className="text-4xl font-black text-slate-200 dark:text-white/10 mb-4 group-hover:text-blue-500/20 transition-colors">{s.step}</div>
                <h4 className="text-lg font-black text-slate-900 dark:text-white mb-2 uppercase tracking-tight">{s.title}</h4>
        ...
        <div className="w-full max-w-6xl mt-32 p-12 bg-slate-50 dark:bg-white/5 rounded-[3rem] border border-slate-200 dark:border-white/10 relative overflow-hidden">
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16">
            <div>
              <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight mb-8 uppercase">Sovereign_Services_</h2>
              <div className="space-y-8">
                <div>
                  <h4 className="text-blue-600 dark:text-blue-400 text-[10px] font-black uppercase tracking-[0.1em] mb-2">Service_01</h4>
                ...
                <div>
                  <h4 className="text-indigo-600 dark:text-indigo-400 text-[10px] font-black uppercase tracking-[0.1em] mb-2">Service_02</h4>
            ...
            <div className="space-y-8 pt-20">
              <div>
                <h4 className="text-emerald-600 dark:text-emerald-400 text-[10px] font-black uppercase tracking-[0.1em] mb-2">Service_03</h4>
              ...
              <div className="p-8 bg-gradient-to-br from-blue-600/20 to-indigo-600/10 rounded-3xl border border-blue-500/30 relative overflow-hidden group">
                ...
                <h3 className="text-xl font-black text-slate-900 dark:text-white mb-2 tracking-tight uppercase">Ready to Integrate?_</h3>
                ...
                <Link href="/docs/sdk" className="block w-full py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-950 rounded-xl text-[10px] font-black uppercase tracking-[0.1em] hover:bg-blue-600 dark:hover:bg-blue-600 hover:text-white dark:hover:text-white transition-all shadow-xl shadow-blue-500/10 text-center">
        ...
        <div className="w-full max-w-6xl mt-32">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight mb-4 uppercase">Role_Based_Architecture_</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-10 glass rounded-[2.5rem] border border-slate-200 dark:border-white/5">
              <div className="text-blue-600 dark:text-blue-500 font-black text-6xl mb-6 opacity-20">DEV</div>
            ...
            <div className="p-10 glass rounded-[2.5rem] border border-slate-200 dark:border-white/5">
              <div className="text-indigo-600 dark:text-indigo-500 font-black text-6xl mb-6 opacity-20">NODE</div>
        ...
        <div className="w-full max-w-6xl mt-32">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight mb-4">Enterprise-Grade Tiers_</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="glass p-8 rounded-[2rem] border border-slate-200 dark:border-white/5 hover:border-slate-300 dark:hover:border-white/20 transition-all flex flex-col">
                <div className={`text-[10px] font-black uppercase tracking-wider text-${plan.color}-600 dark:text-${plan.color}-400 mb-2`}>{plan.tier} Plan</div>
                <div className="text-4xl font-black text-slate-900 dark:text-white mb-4">{plan.price}<span className="text-sm text-slate-500 font-medium">/mo</span></div>
